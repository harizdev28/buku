...
class Model_pesan_reward extends CI_Model
{
    ...
    public function tampil_data()
    {
        ...
        FROM tb_pesan_reward ORDER BY id DESC");
    ...
    public function edit_pesan_reward($where, $table)
    {
        return $this->db->get_where($table, $where);
    }

    //Pembuatan Function update pesanan
    public function update_pesan_reward($where, $data, $table)
    {
        $this->db->where($where);
    ...
    public function hapus_pesan_reward($where, $table)
    {
        $this->db->where($where);
    ...
    public function detail_pesan_reward($id)
    {
        $result = $this->db->where('id', $id)->get('tb_pesan_reward');
        if ($result->num_rows() > 0) {
            return $result->result();
        } else {
            return false;
