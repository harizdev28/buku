<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('admin/data_hadiah') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('admin/invoice') ?>">
          ...
          <span>Data Invoices</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('admin/data_pesan_reward') ?>">
          <i class="fas fa-fw fa-truck"></i>
          <span>Data Pemesanan Reward</span></a>
      </li>
      <!-- Divider -->
