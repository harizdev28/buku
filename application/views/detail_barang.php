            ...
            <?php foreach ($barang as $brg) : ?>
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <?= anchor('dashboard/tambah_ke_keranjang/' . $brg->id_brg, '<div class="btn btn-primary btn-sm">Tambah ke Keranjang</div>') ?>
                        <?= anchor('dashboard/index/', '<div class="btn btn-danger btn-sm">Kembali</div>') ?>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
