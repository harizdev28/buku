...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 container">
        <h1 class="h3 mb-0 text-gray-800 mb-3"><i class="fas fa-file-invoice"></i> <?= $judul; ?></h1>
    </div>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?= anchor('admin/invoice/detail_inv/' . $inv->id, '<div class="btn btn-success btn-sm btn-circle"><i class="fas fa-search-plus"></i></div>') ?>
                                        <?= anchor('admin/invoice/edit/' . $inv->id, '<div class="btn btn-sm btn-warning btn-circle"><i class="fas fa-edit"></i></div>') ?>
                                        <?= anchor('admin/invoice/hapus/' . $inv->id, '<div class="btn btn-sm btn-danger btn-circle"><i class="fas fa-trash-alt"></i></div>') ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php } ?>
